...
/**
 * List constants for HTML tag name and attributes
 *
...
class HTMLConstants
{
	...
	public static inline var HTML_SPAN_TAG_NAME:String = "SPAN";
	...
	public static inline var HTML_SRC_ATTRIBUTE_NAME:String = "src";

	public static inline var HTML_VALUE_ATTRIBUTE_NAME:String = "value";

	public static inline var HTML_AUTOPLAY_ATTRIBUTE_NAME:String = "autoplay";

	public static inline var HTML_LOOP_ATTRIBUTE_NAME:String = "loop";

	public static inline var HTML_TYPE_ATTRIBUTE_NAME:String = "type";
	...
	public static inline function getInputTypeValues():Array<String> {return [INPUT_TYPE_HIDDEN, INPUT_TYPE_TEXT,
