   ...
   */
	...
	override public function createElement(tagName:String):HTMLElement
	{
		...
		switch (tagName)
		{
			...
			case HTMLConstants.HTML_SPAN_TAG_NAME:
				element = new SpanElement(HTMLConstants.HTML_SPAN_TAG_NAME);
	...
	**/
	public function createSpanElement():SpanElement
	{
		return cast createElement(HTMLConstants.HTML_SPAN_TAG_NAME);
	}

	/**
	* A typed shortcut for createElement("p").
	**/
	public function createParagraphElement():ParagraphElement
	{
		return cast createElement(HTMLConstants.HTML_P_TAG_NAME);
	}
